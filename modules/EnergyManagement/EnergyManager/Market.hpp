...
class Market {
public:
    Market(types::energy::EnergyFlowRequest const& _energy_flow_request, const float __nominal_ac_voltage,
    ...
    types::energy::EnergyFlowRequest const& energy_flow_request;

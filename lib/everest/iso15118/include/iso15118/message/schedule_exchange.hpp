...
struct OverstayRulesList {
    ...
    everest::lib::util::fixed_vector<OverstayRule, 5> overstay_rule; // max 5 (OVERSTAY_RULE_LENGTH)
};
...
struct PriceLevelSchedule {
    ...
    everest::lib::util::fixed_vector<PriceLevelScheduleEntry, 1024> price_level_schedule_entries; // max 1024 (PRICE_LEVEL_SCHEDULE_LENGTH)
};
